        ...
        startBrowserButton.setOnClickListener(new View.OnClickListener() {
    		...
    		//	Log.d(LOGTAG, "Start browsing button pressed");
    			Intent fileExploreIntent = new Intent(
						com.am.ahmad.Basics_class.FileBrowserActivity.INTENT_ACTION_SELECT_DIR,
        				null,
        				activityForButton,
						com.am.ahmad.Basics_class.FileBrowserActivity.class
        				);
...
//        				);
        ...
        startBrowser4FileButton.setOnClickListener(new View.OnClickListener() {
    		public void onClick(View v) {
    			...
    			Intent fileExploreIntent = new Intent(
						com.am.ahmad.Basics_class.FileBrowserActivity.INTENT_ACTION_SELECT_FILE,
        				null,
        				activityForButton,
						com.am.ahmad.Basics_class.FileBrowserActivity.class
        				);
...
//        				);
        ...
        start4FileHideNonReadButton.setOnClickListener(new View.OnClickListener() {
    		...
    		//	Log.d(LOGTAG, "StartFileBrowser4File button pressed");
    			...
    			fileExploreIntent.putExtra(
						com.am.ahmad.Basics_class.FileBrowserActivity.showCannotReadParameter,
    					false);
        		startActivityForResult(
        				fileExploreIntent,
        				REQUEST_CODE_PICK_FILE
		...
		if (requestCode == REQUEST_CODE_PICK_DIR) {
        	if(resultCode == RESULT_OK) {
        		String newDir = data.getStringExtra(
						com.am.ahmad.Basics_class.FileBrowserActivity.returnDirectoryParameter);
        		Toast.makeText(
        				this, 
		...
		if (requestCode == REQUEST_CODE_PICK_FILE) {
        	if(resultCode == RESULT_OK) {
        		String newFile = data.getStringExtra(
						com.am.ahmad.Basics_class.FileBrowserActivity.returnFileParameter);
        		Toast.makeText(
        				this, 
